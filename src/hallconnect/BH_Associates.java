 ...
 * @author Lenovo
 */
public class BH_Associates extends javax.swing.JFrame {
  private CentralController controller = new CentralController();
    /**
     * Creates new form loginPage
     */
    public BH_Associates(CentralController controller) {
        this.controller=controller;
        initComponents();
    }
    public BH_Associates() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panel_parent.add(btn_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 610, 140, 54));
        panel_parent.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 193, 330, 10));

        label_login.setFont(new java.awt.Font("Arial Black", 1, 36)); // NOI18N
        label_login.setForeground(new java.awt.Color(255, 255, 255));
        label_login.setText("Hall Associates");
        panel_parent.add(label_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 140, -1, 50));
        ...
        label_home18.setText("Electritian         :");
        jPanel2.add(label_home18, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, -1, 30));

        label_home19.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home19.setForeground(new java.awt.Color(255, 255, 255));
        label_home19.setText("01732347755");
        jPanel2.add(label_home19, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 300, -1, 30));

        label_home22.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home22.setForeground(new java.awt.Color(255, 255, 255));
        label_home22.setText("Cleaner             :");
        jPanel2.add(label_home22, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, -1, 30));
        ...
        label_home26.setText("Guard                :");
        jPanel2.add(label_home26, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, -1, 30));

        label_home27.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home27.setForeground(new java.awt.Color(255, 255, 255));
        label_home27.setText("01732347755");
        ...
        label_home28.setText("01732347755");
        ...
        label_home29.setText("01732347755");
        jPanel2.add(label_home29, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 220, -1, 30));

        label_home30.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home30.setForeground(new java.awt.Color(255, 255, 255));
        label_home30.setText("01732347755");
        jPanel2.add(label_home30, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 220, -1, 30));
        ...
        label_home20.setText("Co-provost           :");
        jPanel4.add(label_home20, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, -1, 30));

        label_home21.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home21.setForeground(new java.awt.Color(255, 255, 255));
        label_home21.setText("Abu Naser Mojumder");
        jPanel4.add(label_home21, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 160, -1, 30));

        label_home24.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home24.setForeground(new java.awt.Color(255, 255, 255));
        label_home24.setText("Provost                :");
        jPanel4.add(label_home24, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, -1, 30));

        label_home25.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        label_home25.setForeground(new java.awt.Color(255, 255, 255));
        label_home25.setText("Abu Naser Mojumder");
        jPanel4.add(label_home25, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 40, -1, 30));

        panel_parent.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, 640, 330));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BH_Associates.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BH_Associates().setVisible(true);
            }
        });
    }
